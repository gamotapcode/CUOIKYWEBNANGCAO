...
namespace CUOIKYLTWEBNANGCAO.Models
{
    public partial class dbQUANLYBANHANGContext : DbContext
    {
        ...
        public virtual DbSet<ApplicationsMenuFormRelation> ApplicationsMenuFormRelations { get; set; }
        public virtual DbSet<Gender> Genders { get; set; }
        public virtual DbSet<GenderType> GenderTypes { get; set; }
        public virtual DbSet<GroupRelationshipMenuForm> GroupRelationshipMenuForms { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-CO9SR14U\\SQLEXPRESS;Initial Catalog=dbQUANLYBANHANG;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationsMenuFormRelation>(entity =>
            {
                entity.HasKey(e => new { e.IdMenuForm, e.IdApplication });

                entity.ToTable("APPLICATIONS_MENU_FORM_RELATIONS");
                ...
                entity.HasOne(d => d.IdApplicationNavigation)
                    .WithMany(p => p.ApplicationsMenuFormRelations)
                    .HasForeignKey(d => d.IdApplication)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_APPLICATIONS_MENU_FORM_RELATIONS_APPLICATIONS");

                entity.HasOne(d => d.IdMenuFormNavigation)
                    .WithMany(p => p.ApplicationsMenuFormRelations)
                    .HasForeignKey(d => d.IdMenuForm)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.PartyId, e.GenderTypeId, e.FromDate })
            ...
            modelBuilder.Entity<GroupRelationshipMenuForm>(entity =>
            {
                entity.HasKey(e => new { e.PartyId, e.IdGroup, e.IdMenuForm });

                entity.ToTable("GROUP_RELATIONSHIP_MENU_FORM");
                ...
                entity.HasOne(d => d.IdMenuFormNavigation)
                    .WithMany(p => p.GroupRelationshipMenuForms)
                    .HasForeignKey(d => d.IdMenuForm)
                    .HasConstraintName("FK_GROUP_RELATIONSHIP_MENU_FORM_MENU_FORM");

                entity.HasOne(d => d.GroupUserRelationshipUser)
                    .WithMany(p => p.GroupRelationshipMenuForms)
                    .HasForeignKey(d => new { d.PartyId, d.IdGroup })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.PartyId, e.IdGroup })
                ...
                entity.HasOne(d => d.IdGroupNavigation)
                    .WithMany(p => p.GroupUserRelationshipUsers)
            ...
            modelBuilder.Entity<MenuForm>(entity =>
            {
                ...
                entity.HasOne(d => d.IdMenuFormParentNavigation)
                    .WithMany(p => p.InverseIdMenuFormParentNavigation)
            ...
            modelBuilder.Entity<TbDanhmuc>(entity =>
            {
                entity.HasKey(e => e.Madanhmuc)
                    .HasName("PK__tbDANHMU__804E2884F76FB428");
            ...
            modelBuilder.Entity<TbSanpham>(entity =>
            {
                entity.HasKey(e => e.Masanpham)
                    .HasName("PK__tbSANPHA__9534C89226C51683");
